            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs"
                                                                             target="_blank"
                                                                             class="underline text-gray-900 dark:text-white">Safety</a>
                        </div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            You want to know how safe our Website is? Luckly you are able to. Just add the name of the
                            user aboveright behind the /users/ in the URL and then go. Here an example:
                            <br><strong><a
                                    href="http://{{ $_SERVER['SERVER_NAME'] }}:8000/users/{{ App\Models\User::find(1)->username }}">{{ $_SERVER['SERVER_NAME'] }}
                                    /users/{{ App\Models\User::find(1)->username }}</a></strong>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="/all-users"
                                                                             class="underline text-gray-900 dark:text-white">All
                                Our Users</a></div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            To show how much we valuate our Users we decidet to show them all here <br> <strong><a
                                    href="/all-users">Some Users</a> </strong>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel-news.com/"
                                                                             target="_blank"
                                                                             class="underline text-gray-900 dark:text-white">Give
                                us your Information</a></div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            <a href="http://{{ $_SERVER['SERVER_NAME'] }}:8000/views/daniel-{{ rand(12,45) }}">
                                Want to see what basic routing and Laravel can do? Just type in the URL search bar
                                following things: <br> <strong>127.0.0.1:8000/views/(your name)-(your age)</strong>
                            </a>
                        </div>
                    </div>
                </div>
